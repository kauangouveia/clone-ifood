...
-- AddForeignKey
ALTER TABLE "Product" ADD CONSTRAINT "Product_categoorieId_fkey" FOREIGN KEY ("categoorieId") REFERENCES "Category"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
